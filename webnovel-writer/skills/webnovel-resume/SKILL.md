...
if [ -z "${CODEX_PLUGIN_ROOT}" ] || [ ! -d "${CODEX_PLUGIN_ROOT}/skills/webnovel-resume" ]; then
  echo "ERROR: 未设置 CODEX_PLUGIN_ROOT 或缺少目录: ${CODEX_PLUGIN_ROOT}/skills/webnovel-resume" >&2
  exit 1
fi
export SKILL_ROOT="${CODEX_PLUGIN_ROOT}/skills/webnovel-resume"
